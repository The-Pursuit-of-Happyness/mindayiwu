  ...
  <div class="home">
       <div class="lunbo">
        ...
        <div class="box">
            ...
            <img src="../assets/lunbo4.jpg">
            <img src="../assets/lunbo5.jpg">
            <img src="../assets/lunbo6.jpg">
            <img src="../assets/lunbo1.jpg">
        </div>
        <!--
        <div class="btn">
...
function xiaoguo(n){
	...
	$('.dian').animate({'width':width+'px'},2000);
	$('.dian').animate({'width':0+'px'},100);
	$('.box').animate({'margin-left':-n*width+'px'},2000,function(){
		if(n==6){
